                    ...
                    child: Stack(fit: StackFit.loose, children: [
                      ...
                      Positioned(
                          ...
                          child: Align(
                            ...
                            child: Center(
                              child: Text(
                                'What Questions Should You Ask A Furry  Breeder ?',
                                style: TextStyle(
                                  fontSize: 20,
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(height: height / 55),
                                Text(
                                  "Once you’ve answered these basic questions, you’ll have a better picture of what characteristics you’re looking for in a Furry . This will help to narrow your search as you research breeds based on your answers.You can learn more about each unique Furry  breed by searching our Petfinder breed guide by name, collection (largest, smartest, and even hairless!), or just browse them all right here. It’s fascinating to discover the history behind each of the countless Furry  breeds. From small to large, each has a unique story.Even if you have your heart set on a particular breed, there’s an additional factor to keep in mind: Every Furry —even a purebred–is distinct and individual.Despite what is considered typical of a breed, you’ll need to remember that every Furry  in the world has their own unique personality (that’s why we love Furry s!) and some may have characteristics that aren’t commonly found within their breed. Luckily, when Furry s arrive with an adoption group, the shelter or rescue will often do a behavioral assessment that can give you more insight about an individual Furry  before you make a decision about adopting. This pre-adoption info can help you find the very best fit for your family and lifestyle.",
                                  style: TextStyle(
                                    height: 1.5,
                                    fontSize: 12,
                                    fontFamily: 'Comfortaa-VariableFont_wght',
