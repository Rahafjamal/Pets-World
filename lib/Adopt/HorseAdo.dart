                            ...
                            child: Align(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(height: height / 55),
                                  Text(
                                    'When adopting an adult Horse, you can specifically look for one whose story matches your needs, such as being friendly with other Horses, being good with children, and other past history that the rescue or shelter may already have. Having more history on a Horse will mean fewer surprises for you as an adopter.',
                                    style: TextStyle(
                                      height: 1.5,
                                      fontSize: 12,
                                      fontFamily: 'Comfortaa-VariableFont_wght',
